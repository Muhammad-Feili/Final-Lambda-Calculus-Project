...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','example.py',63),
  ('statement -> expression','statement',1,'p_statement_expr','example.py',68),
  ('expression -> expression + expression','expression',3,'p_expression_binop','example.py',72),
  ('expression -> expression - expression','expression',3,'p_expression_binop','example.py',73),
  ('expression -> expression * expression','expression',3,'p_expression_binop','example.py',74),
  ('expression -> expression / expression','expression',3,'p_expression_binop','example.py',75),
  ('expression -> - expression','expression',2,'p_expression_uminus','example.py',86),
  ('expression -> ( expression )','expression',3,'p_expression_group','example.py',90),
  ('expression -> NUMBER','expression',1,'p_expression_number','example.py',94),
  ('expression -> NAME','expression',1,'p_expression_name','example.py',98),
]
